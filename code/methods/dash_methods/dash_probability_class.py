...
class DashProbability():
    ...
    def calculate_probability(self, 
        ...
        self.adding_ts_df = calc_prob_helper_func.calc_prob_after_adding_to_existing_high_attn_ts(**self.probability_params)
        pass


    
    def plot_probability_in_plotly(self, show_plot=True):
        self.fig = plotly_probability.plot_success_rate_after_adding_to_high_attn_ts(self.adding_ts_df, high_attn_ts=self.probability_params['high_attn_ts'], show_plot=show_plot)
    ...
    def prepare_dash_for_main_plots_layout(self, id_prefix=''):
        ...
        return html.Div([
                        ...
                        dash_prob_helper_func.put_down_main_plot(self.fig),
                        ])
